...
<body>
    <table width="100%">
        <tr>
            <td rowspan="4" width="60%">
                ...
                <span class="nama-perusahaan">{{ $setting->nama_perusahaan }}</span>
                <br>
                <br>
                <br>
                {{ $setting->alamat }}
    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            ...
            <tr>
                <td colspan="6" class="text-right"><b>Hutang Customer</b></td>
            ...
            <tr>
                <td colspan="4" class="text-center"><b>Keterangan: {{ session('isBon') === 'true' ? 'BON' : 'LUNAS' }}</b></td>
